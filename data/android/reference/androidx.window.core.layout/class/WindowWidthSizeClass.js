module.exports.WindowWidthSizeClass = (req, res) => {
    console.log("okh");
    res.status(200).send({
      name: "WindowWidthSizeClass",
      hCode: `public final class <a href="#WindowWidthSizeClass">WindowWidthSizeClass</a>`,
  
      des: 
        `
        <p>WindowWidthSizeClass class ka use, window ke available width ko compact, medium, ya expanded size classes mein classify karne ke liye hota hai. Isse aap apne app ke layout ko responsive aur adaptive bana sakte hain, aur alag-alag screen sizes aur configurations ko support kar sakte hain.</p>
        
  
        <p>WindowWidthSizeClass class ka use karke aap apne app ke layout ko window ke width ke hisab se adjust kar sakte hain. Aap WindowMetricsCalculator class ka use karke current window metrics ko get kar sakte hain, aur uske baad WindowWidthSizeClass class ka use karke current window width size class ko get kar sakte hain. Isse aap apne app ke UI elements ko show ya hide kar sakte hain, ya unka size ya position change kar sakte hain.</p>
